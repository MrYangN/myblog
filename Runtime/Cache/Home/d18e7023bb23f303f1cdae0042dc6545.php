...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-5 col-md-offset-2 mianbao">
			<img src="/Public/img/home/address.png" alt="面包屑导航"><h2>情感故事</h2>
			<span>时间的沙漏沉淀着无法逃离的过往和那些讲不出的故事&nbsp;&nbsp; —— Mr.Yang</span>
		</div>
		<div class="col-md-3">
   ...
   <div class="row">
   		...
   		<?php if(is_array($list)): foreach($list as $key=>$row): ?><article class="bogs" style="padding:30 10">
				<figure class="col-md-3">
					<a href="/Home/Love/detail" title="<?php echo ($row["title"]); ?>" target="_blank">
						<img src="/Public/Uploads/admin/<?php echo ($row["images"]); ?>" alt="文章图片" title="<?php echo ($row["title"]); ?>">
					</a>
				</figure>
				<div class=" col-md-9 bogs_list">
					<h3><a href="/Home/Love/detail" target="_blank"><?php echo ($row["title"]); ?></a></h3>
					<?php echo (mb_strcut($row["content"],0,270,utf8)); ?>...<a href="/Home/Love/detail" target="_blank" class="xiangqin">[详情]</a>
					<p class="autor" style="margin:0px;margin-left:20px;margin-top:10px">
						<span ><img src="/Public/img/home/tar.png" alt="文章分类" style="width:20px;height:20px"><a href="/Home/Love/detail" target="_blank" style="color: #759b08;margin-left:5px;font-size:12px"><?php echo ($row["typename"]); ?></a></span>
						...
						<span class="f_r"><a href="/Home/Love/detail"><img src="/Public/img/home/pinglun.png" alt="评论" style="width:17px;height:17px"><span>评论( <?php echo ($row["comment"]); ?> )</span></a></span>
					</p>
				</div>
