		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		            	<span class="pull-left" style="margin-left:20px">
		                   <input type="checkbox" id="remember"><small>记住密码(保存一周)</small>
		                </span>
		                <span class="pull-right">
		                    <a data-toggle="modal" href="login.html#myModal"> Forgot Password?</a>
		                </span>
		            </label>
		            <button class="btn btn-theme btn-block"   id="sub"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
         ...
         $(function() {
            $("#sub").click(function(){
            	...
            	$.ajax({
            		...
            		type:'POST',
            		data:{username:$("#username").val(),pwd:$("#pwd").val(),flag:flag},
            		dataType:'JSON',
