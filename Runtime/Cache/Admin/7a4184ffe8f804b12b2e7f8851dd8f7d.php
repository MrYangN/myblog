                  ...
                  <form action="/Admin/Article/index" method="get">
                    ...
                    <hr>
                      ...
                      <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr  id="tr_<?php echo ($row["id"]); ?>">
                            ...
                            <?php if($row["type"] == 1): ?><td style="color:red">情感故事</td><?php endif; ?>
                             <?php if($row["type"] == 2): ?><td style="color:blue">技术分享</td><?php endif; ?>
                            <td><?php echo (date("Y-m-d H:i:s",$row['curentTime'])); ?></td>
                            <td><?php echo ($row["typename"]); ?></td>
                            <td><?php echo ($row['readCount']); ?></td>
                            <td><?php echo ($row['comment']); ?></td>
                            <td>
                                <a href="/Admin/Article/edit/id/<?php echo ($row["aid"]); ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>&nbsp;&nbsp;
                                <a class="btn btn-danger btn-xs"href="javascript:;"  onclick="if(confirm('确定要删除该文章吗')){ deleteData(<?php echo ($row["aid"]); ?>)}"><i class="fa fa-trash-o "></i></a>
                            </td>
