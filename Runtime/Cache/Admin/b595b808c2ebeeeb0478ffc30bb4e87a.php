...
<html lang="en">
  <head>
    ...
    <meta name="keyword" content="杨先森博客商城, 杨先森博客官网, qidong">
                      ...
                      <!-- SERVER STATUS PANELS -->
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
										<img src="/Public/img/product.png" width="120">
	                      		</div>
                      		</div>
                      	</div><!-- /col-md-4 -->
						...
						<div class="col-md-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="/Public/img/ui-zac.jpg" class="img-circle" width="80"></p>
								<p><b>Zac Snider</b></p>
								<div class="row">
									<div class="col-md-6">
      ...
      *********************************************************************************************************************************************************** -->                  
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="/Public/img/ui-divya.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="/Public/img/ui-sherman.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="/Public/img/ui-danro.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="/Public/img/ui-zac.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="img-circle" src="/Public/img/ui-sam.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
...
<footer class="site-footer" style="margin-top:20px">
  <div class="text-center">
      2017.yangning<a href="" target="_blank" title="模板之家">杨先森后台管理</a>杨先森 <a href="" title="杨先森" target="_blank">杨先森后台</a>
  </div>
</footer>
      <!--footer end-->
  </section>
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            // (string | mandatory) the heading of the notification 通知的标题
            title: '欢迎来到杨先森博客后台管理!',
            // (string | mandatory) the text inside the notification 通知内的文本
            text: '这是杨先森博客的后台管理界面，可以点击左边隐藏左侧列表。 <a href="" target="_blank" style="color:#ffd777">打开前台</a>.',
            // (string | optional) the image to display on the left
            image: '/Public/img/ui-sam.jpg',
            // (bool | optional) if you want it to fade out on its own or just sit there 如果你想让它自己消失或者只是坐在那里
            sticky: true, 
